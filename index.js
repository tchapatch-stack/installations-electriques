...
if (heure == 19)				 // de 19h00 à 19h59
	mes=mes+"tu sais que tu rates le feuilleton<P>";
...
if ((jour== 7)&&(mois== 1))	{
	age= annee - 1943;
	mes=mes+"<font color='FF9966'>il y a "+ age  + " ans : mourrait <a href='Divers/dico/H_Tesla.htm'>Nikolas Tesla  <P></FONT>";
	}
if ((jour== 12)&&(mois== 1))	{
	age= annee - 1665
	mes=mes+"<font color='FF9966'>il y a "+ age  + " ans mourrait Pierre Fermat</a> <P></FONT>";
	}
if ((jour== 17)&&(mois== 1))	{
	age= annee - 1706
